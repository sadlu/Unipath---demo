...
import { registerEmail, verifyEmail, getProfile, uploadAvatar, updateProfile } from '../services/api'
    ...
    <div className="w-full max-w-2xl mx-auto px-5 pb-10">
      ...
      <div className="w-full bg-[#1E1B2E] border border-[#2D2A3E] rounded-2xl p-5 flex flex-col items-center gap-3">
        <div className="relative">
          ...
          <label className="absolute -bottom-1 -right-1 w-6 h-6 bg-[#7C5CFC] rounded-full flex items-center justify-center cursor-pointer hover:bg-[#6D4FF2] transition-colors shadow-lg">
      ...
      <div className="w-full bg-[#1E1B2E] border border-[#2D2A3E] rounded-2xl p-5 flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
          <button onClick={() => { setEditName(userData.displayName); setShowEditProfile(true) }} className="flex items-center justify-between px-3 py-3 rounded-xl hover:bg-white/5 transition-colors">
        ...
        {showEditProfile && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm bg-[#1E1B2E] border border-[#2D2A3E] rounded-2xl p-6 shadow-2xl"
            >
              <h3 className="text-lg font-extrabold text-white mb-4">Edit Profile</h3>
        ...
        {showChangePassword && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm bg-[#1E1B2E] border border-[#2D2A3E] rounded-2xl p-6 shadow-2xl"
            >
              <h3 className="text-lg font-extrabold text-white mb-4">Change Password</h3>
